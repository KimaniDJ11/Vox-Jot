...
| OmniVoice                             | TTS                       | [`k2-fsa/OmniVoice`](https://hf.co/k2-fsa/OmniVoice)                                                                                                                   | Blocked                                  | Public Apache-2.0, 646+ language tags and voice cloning. The downloaded MLX checkpoint produced silent WAVs in the full hard suite. Keep disabled until the bridge emits non-silent audio.                   |
