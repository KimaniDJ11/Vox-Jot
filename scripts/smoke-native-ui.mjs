...
function main() {
  ...
  const steps = [
    ...
    [
      "Dictation Modes",
      ["Dictation Modes", "Write profiles", "Write Profiles"],
      { x: () => 82, y: () => 78 },
    ],
    ["Phrase Keys", ["Phrase Keys"], { x: () => 82, y: () => 124 }],
    ["Translation", ["Translation"], { x: () => 82, y: () => 170 }],
    ["Listen", ["Listen"], { x: (width) => width / 2 + 92, y: () => 24 }],
    ["Studio", ["Studio"], { x: () => 82, y: () => 78 }],
    ["Voice Design", ["Voice Design"], { x: () => 82, y: () => 124 }],
    ["Voice Cloning", ["Voice Cloning"], { x: () => 82, y: () => 170 }],
    ...
    ["Output & Paste", ["Output & Paste"], { x: () => 82, y: () => 259 }],
    ["Corrections", ["Corrections"], { x: () => 82, y: () => 348 }],
    ...
    ["Diagnostics", ["Diagnostics"], { x: () => 82, y: () => 756 }],
    ["About Vox Jot", ["About Vox Jot"], { x: () => 82, y: () => 809 }],
    [
      "Model Hub",
