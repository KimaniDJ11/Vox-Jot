        ...
        style_controls=(
            {
                "id": "speed",
                "label": "Speed",
                "description": "Adjusts Kokoro playback speed without changing the preset-wide speech rate.",
                "kind": "slider",
                "min": 0.5,
                "max": 2.0,
                "step": 0.05,
    ...
    EngineSpec(
        ...
        style_controls=(
            ...
            },
            {
                "id": "top_k",
                "label": "Top K",
                "description": "Restricts sampling to the most likely token candidates.",
                "kind": "slider",
                "min": 10.0,
                "max": 100.0,
                "step": 1.0,
            },
            {
                "id": "top_p",
                "label": "Top P",
                "description": "Restricts sampling to the most likely cumulative token mass.",
                "kind": "slider",
                "min": 0.5,
                "max": 1.0,
                "step": 0.05,
    ...
    EngineSpec(
        ...
        style_controls=(
            ...
            },
            {
                "id": "top_p",
                "label": "Top P",
                "description": "Limits sampling to the most likely next-token mass.",
                "kind": "slider",
                "min": 0.5,
                "max": 1.0,
                "step": 0.05,
