...
ENGINE_SPECS: tuple[EngineSpec, ...] = (
    ...
    EngineSpec(
        ...
        label="Supertonic 3",
        description="Ultra-fast multilingual ONNX TTS with fixed voice styles and inline expression tags.",
        engine_family="supertonic",
        license_label="OpenRAIL-M",
        model_dirs=("supertonic-3", "Supertone/supertonic-3"),
        supported_languages=SUPERTONIC_LANGUAGES,
        supports_voice_cloning=False,
        supports_instruction_prompt=False,
        supports_inline_tags=True,
        default_voice="M1",
        style_controls=(
            {
                ...
                "group": "tempo",
                "label": "Tempo",
                "description": "Adjusts Supertonic speech speed.",
                "kind": "slider",
                "min": 0.7,
                "max": 2.0,
                "step": 0.05,
            ...
            },
            {
                ...
                "group": "sampler",
                "label": "Quality Steps",
                "description": "Sets Supertonic denoising steps; higher can improve quality at the cost of latency.",
                "kind": "slider",
                "min": 1,
                "max": 12,
                "step": 1,
