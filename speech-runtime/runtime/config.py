...
ENGINE_SPECS: tuple[EngineSpec, ...] = (
    EngineSpec(
        ...
        license_label="MIT",
        model_dirs=("OpenVoice/OpenVoice", "openvoice/openvoice", "OpenVoice", "openvoice"),
        ...
        style_controls=(
            {
                ...
                "group": "sampler",
                "label": "Temperature",
                "description": "Controls sampling variation during Turbo speech-token generation.",
                "kind": "slider",
                "min": 0.1,
                "max": 1.0,
                "step": 0.05,
            ...
            },
            {
                ...
                "group": "sampler",
                "label": "Top K",
                "description": "Caps how many candidate speech tokens can be sampled.",
                "kind": "slider",
                "min": 1,
                "max": 1000,
                "step": 1,
    ...
    EngineSpec(
        ...
        supported_languages=CHATTERBOX_MULTILINGUAL_LANGUAGES,
        supports_voice_cloning=True,
        supports_instruction_prompt=False,
        supports_inline_tags=False,
        default_voice=None,
        style_controls=(
            ...
            },
            {
                ...
                "group": "sampler",
                "label": "Randomness",
                "description": "Balances predictable versus more varied multilingual delivery.",
                "kind": "slider",
                "min": 0.0,
                "max": 1.0,
                "step": 0.05,
    ...
    EngineSpec(
        ...
        license_label="Apache-2.0",
        model_dirs=("Kokoro/kokoro", "kokoro/kokoro", "Kokoro", "kokoro"),
