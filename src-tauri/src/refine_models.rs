...
const HF_IMPORT_SPECS: &[HfImportSpec] = &[
    HfImportSpec {
        id: "hf:phi-3-mini-4k",
        title: "Phi-3 Mini 4K",
        description: "Official Microsoft GGUF import for compact instruction following and cleanup.",
    ...
    HfImportSpec {
        id: "hf:gemma-3-4b",
        title: "Gemma 3 4B IT",
        description: "Google Gemma GGUF import for lightweight instruction-tuned cleanup.",
        repo_id: "bartowski/google_gemma-3-4b-it-GGUF",
        file_name: "google_gemma-3-4b-it-Q4_K_M.gguf",
        runtime_model_id: "google-gemma-3-4b-it-q4_k_m",
    },
    HfImportSpec {
        id: "hf:qwen3-4b",
        title: "Qwen3 4B",
        description: "Official Qwen GGUF import with a small footprint and strong general cleanup quality.",
        repo_id: "Qwen/Qwen3-4B-GGUF",
        file_name: "Qwen3-4B-Q4_K_M.gguf",
        runtime_model_id: "qwen3-4b-q4_k_m",
    },
    HfImportSpec {
        id: "hf:nemotron-3-nano-4b",
        title: "Nemotron 3 Nano 4B",
        description: "Import from Hugging Face as a GGUF Ollama model.",
        repo_id: "nvidia/NVIDIA-Nemotron-3-Nano-4B-GGUF",
        file_name: "NVIDIA-Nemotron3-Nano-4B-Q4_K_M.gguf",
        runtime_model_id: "nemotron-3-nano-4b-q4_k_m",
    },
    HfImportSpec {
        id: "hf:qwen3.5-9b",
        title: "Qwen3.5 9B",
        ...
        runtime_model_id: "qwen3.5-9b-q4_k_m",
    },
    HfImportSpec {
        id: "hf:qwen3-8b",
        title: "Qwen3 8B",
        description: "Official Qwen GGUF import with more headroom for cleanup, rewrite, and translation tasks.",
        repo_id: "Qwen/Qwen3-8B-GGUF",
        file_name: "Qwen3-8B-Q4_K_M.gguf",
        runtime_model_id: "qwen3-8b-q4_k_m",
    },
    HfImportSpec {
        id: "hf:granite-3.3-8b",
        title: "Granite 3.3 8B Instruct",
        description: "Official IBM Granite GGUF import for stronger instruction-following while staying in the small-model band.",
        repo_id: "ibm-granite/granite-3.3-8b-instruct-GGUF",
        file_name: "granite-3.3-8b-instruct-Q4_K_M.gguf",
        runtime_model_id: "granite-3.3-8b-instruct-q4_k_m",
    },
];
