      ...
      {expanded ? (
        ...
        >
          ...
          <input
            ...
            placeholder={label}
            className="h-9 w-full rounded-full border border-[var(--border)] bg-[var(--input)] py-1 pl-8 pr-8 text-xs text-[var(--text)] outline-none placeholder:text-[var(--muted)] focus:border-[var(--accent)] focus:ring-2 focus:ring-[var(--accent-glow)]"
          />
          {query ? (
            <button
              type="button"
        ...
        <button
          ...
          className={`inline-flex h-9 w-9 items-center justify-center rounded-full border border-[var(--border)] bg-[var(--input)] transition-colors hover:border-[var(--accent)] hover:bg-[var(--accent-soft)] hover:text-[var(--accent)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] ${
            query ? "text-[var(--accent)]" : "text-[var(--muted)]"
          }`}
        >
