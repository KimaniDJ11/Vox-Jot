...
const previewButtonClassName = `group relative overflow-hidden rounded-2xl border p-3 text-left transition-all duration-150 ${interactiveFocusRingClass}`;

const selectedPreviewClassName =
...
const unselectedPreviewClassName =
  ...
  return (
    <button
      ...
      className={`${previewButtonClassName} ${
        selected ? selectedPreviewClassName : unselectedPreviewClassName
