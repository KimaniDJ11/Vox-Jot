...
export const CREATIVE_AUDIO_EVALUATION_RUN = {
  ...
  reportPath:
    "output/creative-audio-eval/app-full-2026-05-25-mac-open-models-final/creative-audio-eval-summary.json",
};
  ...
  [
    {
      ...
      audioHealth: 1,
      notes:
        "Full installed-app Creative Audio suite passed for stability_ai/stable-audio-3-small-sfx.",
      rank: 2,
    },
    {
      ...
      audioHealth: 1,
      notes:
        "Full installed-app Creative Audio suite passed for stability_ai/stable-audio-3-small-music.",
      rank: 1,
    },
    {
      ...
      audioHealth: 1,
      notes:
        "Full installed-app Creative Audio suite passed for musicgen/musicgen-small.",
      rank: 5,
    },
    {
      modelId: "audioldm2",
      ...
      audioHealth: 1,
      notes:
        "Full installed-app Creative Audio suite passed for audioldm2/audioldm2.",
      rank: 4,
    },
    {
      ...
      audioHealth: 1,
      notes:
        "Full installed-app Creative Audio suite passed for audioldm2_music/audioldm2-music.",
      rank: 3,
    },
  ];
