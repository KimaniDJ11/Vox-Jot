...
export const SPEAKER_ISOLATION_EVALUATION_RESULTS: SpeakerIsolationEvaluationResult[] = [
  ...
  },
  {
    ...
    device: "gpu",
    notes:
      "Pristine vocal isolation and music separation on Apple Silicon.",
  },
  {
    ...
    device: "mps",
    notes:
      "Robust meeting diarization engine with 26.3x real-time speed.",
  },
  {
    ...
    device: "mps",
    notes:
      "Industry standard speaker diarization pipeline.",
  },
];
