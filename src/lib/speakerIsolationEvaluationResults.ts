...
export const SPEAKER_ISOLATION_EVALUATION_RESULTS: SpeakerIsolationEvaluationResult[] =
  [
    ...
    },
    {
      ...
      device: "cpu",
      notes:
        "WhisperX ASR ran, but diarization matched the one-speaker pyannote behavior and was the slowest tested option. Runtime uses whisperx==3.4.2 with patched Transformers 5.3 / Hugging Face Hub 1.4 pins; NeMo is excluded until it can resolve above the Transformers security floor.",
    },
    {
