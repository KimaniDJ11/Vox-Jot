...
export const STT_EVALUATION_RUN = {
  ...
  limitations:
    "Measured on Apple Silicon (M4 Pro) with 1 warm-up and 3 measured runs. Ranks are determined by domain-weighted WER followed by P50 latency. Fun-ASR Nano and Sherpa Zipformer remain unranked until their installed-app runtime paths are implemented and verified.",
  metricGuide: [
...
export const STT_EVALUATION_RESULTS: SttEvaluationResult[] = [
  ...
  },
  {
    ...
    notes:
      "The full-suite benchmark artifact exists, but this Hugging Face conversion targets mlx-audio-plus and produces invalid output through Vox Jot's pinned mlx-audio runtime. It is intentionally unranked and absent from Model Hub until a verified app-managed bridge is available.",
  },
  {
  ...
  },
  {
    ...
    notes:
      "The benchmark artifact is present, but Vox Jot does not yet have a selectable installed-app runtime bridge for this Zipformer build. It is intentionally unranked and absent from Model Hub until that path works.",
  },
  {
